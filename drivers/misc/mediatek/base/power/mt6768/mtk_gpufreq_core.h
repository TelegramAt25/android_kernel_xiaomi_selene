...
#define SEG_GPU_DVFS_VOLT0		(92000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT1		(89500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT2		(87000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT3		(84500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT4		(82000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT5		(79500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT6		(77000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT7		(76375)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT8		(75125)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT9		(73875)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT10		(72625)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT11		(72000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT12		(70750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT13		(69500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT14		(69250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT15		(67625)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT16		(67000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT17		(66375)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT18		(65750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT19		(65125)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT20		(63875)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT21		(63875)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT22		(63250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT23		(62625)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT24		(62000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT25		(62375)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT26		(62375)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT27		(60750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT28		(60125)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT29		(59500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT30		(58875)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT31		(58250)		/* mV x 100 */

#define SEG_GPU_DVFS_VSRAM0		(102000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM1		(100500)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM2		(97000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM3		(94500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM4		(92000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM5		(89500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM6		(87000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM7		(86375)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM8		(85125)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM9		(83875)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM10	(82625)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM11	(82000)		/* mV x 100 */
